---
title: 'Inicio rápido'
description: 'Ejemplo de envío de una factura ordinaria básica'
---
...
Se trata de la remisión de un registro de facturación de alta de factura ordinaria por un total de `121.00€`, con un concepto por valor de `100.00€` + IVA del `21.00%`.
