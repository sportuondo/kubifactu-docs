...
Si el envío falla por un problema técnico de conexión (timeout, error del servidor o falta de respuesta), **no debes modificar la factura ni generar un nuevo registro**.
...
Solo debe utilizarse la subsanación cuando la AEAT haya rechazado explícitamente el registro.
